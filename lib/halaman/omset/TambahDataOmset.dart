...
class TambahDataOmset extends StatefulWidget {
  ...
  @override
  State<TambahDataOmset> createState() => _TambahDataOmsetState();
}

class _TambahDataOmsetState extends State<TambahDataOmset> {
  ...
  Future SubmitSimpan() async {
    ...
    var Endpoint_API = "api/sistem_gudang/v1/omset/tambah_data_omset.php";
    Map data_body = {
      ...
      final response = await http
        ...
        if (value.statusCode == 200) {
          ...
          if (data['Status'] == "Sukses") {
            ...
            var Array_Object_Pembayaran =
                jsonDecode(data['Data']['Array_Object_Id_Pembayaran']);

            Future.forEach(Array_Object_Pembayaran, (var Id_Pembayaran) {
              var Ambil_Nama_Pembayaran = ListDataPembayaran.firstWhere(
                  (data) => data["Id_Pembayaran"] == Id_Pembayaran.toString(),
                  orElse: () => null);
              var Nama_Pembayaran = "-";
